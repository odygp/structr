...
export default function ShowcaseWithLinks({ content, colorMode }: { content: Record<string, any>; colorMode?: ColorMode }) {
              ...
              {items.slice(0, 3).map((item, i) => (
                <div key={i} className={`${c.bgCard} rounded-xl p-4 flex flex-col`}>
                  ...
                  <div className="mt-auto pt-3">
                    <span className={`text-sm font-medium ${c.text} underline underline-offset-2 cursor-pointer`}>
                      Learn More..
                    </span>
                  </div>
                </div>
